...
class Simple_Events_Meta_Boxes {
    ...
    public function add_meta_boxes() {
        ...
        add_meta_box(
            'se_event_pricing',
            __('Pricing Information', 'simple-events'),
        ...
        <div class="se-event-meta">
            <div class="se-event-meta__row">
                <div class="se-event-meta__field se-event-meta__field--full">
                    <label for="se_event_short_description"><?php esc_html_e('Short description for cards', 'simple-events'); ?></label>
                    <textarea id="se_event_short_description" name="se_event_short_description" maxlength="200" placeholder="<?php esc_attr_e('Brief description for event cards (100–150 characters)', 'simple-events'); ?>"><?php echo esc_textarea($event['short_description']); ?></textarea>
                    <p class="description"><?php esc_html_e('Shown on archive cards and the shortcode grid.', 'simple-events'); ?></p>
                </div>
            </div>

            <div class="se-event-meta__row">
                <div class="se-event-meta__field">
                    <label for="se_event_date"><?php esc_html_e('Start date', 'simple-events'); ?> <span class="required">*</span></label>
                    <input type="date" id="se_event_date" name="se_event_date" value="<?php echo esc_attr($event['date']); ?>" required />
                </div>
                <div class="se-event-meta__field">
                    <label for="se_event_end_date"><?php esc_html_e('End date (optional)', 'simple-events'); ?></label>
            ...
            <div class="se-event-meta__row">
                <div class="se-event-meta__field">
                    <label for="se_event_time"><?php esc_html_e('Start time', 'simple-events'); ?></label>
                    <input type="time" id="se_event_time" name="se_event_time" value="<?php echo esc_attr($event['time']); ?>" />
                </div>
                <div class="se-event-meta__field">
                    <label for="se_event_end_time"><?php esc_html_e('End time', 'simple-events'); ?></label>
            ...
            <div class="se-event-meta__row">
                <div class="se-event-meta__field se-event-meta__field--full">
                    <label for="se_event_location"><?php esc_html_e('Venue / location name', 'simple-events'); ?> <span class="required">*</span></label>
            ...
            <div class="se-event-meta__row">
                <div class="se-event-meta__field se-event-meta__field--full">
                    <label for="se_event_address"><?php esc_html_e('Street address', 'simple-events'); ?></label>
            ...
            <div class="se-event-meta__row">
                <div class="se-event-meta__field">
                    <label for="se_event_city"><?php esc_html_e('City', 'simple-events'); ?></label>
                    <input type="text" id="se_event_city" name="se_event_city" value="<?php echo esc_attr($event['city']); ?>" />
                </div>
                <div class="se-event-meta__field">
                    <label for="se_event_state"><?php esc_html_e('State', 'simple-events'); ?></label>
                    <select id="se_event_state" name="se_event_state">
                        <option value=""><?php esc_html_e('Select state', 'simple-events'); ?></option>
                ...
                <div class="se-event-meta__field">
                    <label for="se_event_zip"><?php esc_html_e('ZIP code', 'simple-events'); ?></label>
            ...
            <div class="se-event-meta__row">
                <div class="se-event-meta__field">
                    <label for="se_event_phone"><?php esc_html_e('Contact phone', 'simple-events'); ?></label>
                    <input type="tel" id="se_event_phone" name="se_event_phone" value="<?php echo esc_attr($event['phone']); ?>" />
                </div>
                <div class="se-event-meta__field">
                    <label for="se_event_email"><?php esc_html_e('Contact email', 'simple-events'); ?></label>
            ...
            <div class="se-event-meta__row">
                <div class="se-event-meta__field">
                    <label for="se_event_website"><?php esc_html_e('Event website', 'simple-events'); ?></label>
                    <input type="url" id="se_event_website" name="se_event_website" value="<?php echo esc_attr($event['website']); ?>" placeholder="https://" />
                </div>
                <div class="se-event-meta__field">
                    <label for="se_event_registration_link"><?php esc_html_e('Registration / ticket URL', 'simple-events'); ?></label>
                    ...
                    <p class="description"><?php esc_html_e('Opens in a new tab from event cards and the single event page.', 'simple-events'); ?></p>
                </div>
            </div>

            <div class="se-event-meta__row">
                <div class="se-event-meta__field">
                    <label for="se_event_age_range"><?php esc_html_e('Age range', 'simple-events'); ?></label>
                    <input type="text" id="se_event_age_range" name="se_event_age_range" value="<?php echo esc_attr($event['age_range']); ?>" placeholder="<?php esc_attr_e('e.g., 5–12 years', 'simple-events'); ?>" />
                </div>
                <div class="se-event-meta__field">
                    <label for="se_event_capacity"><?php esc_html_e('Capacity / availability', 'simple-events'); ?></label>
                    <input type="text" id="se_event_capacity" name="se_event_capacity" value="<?php echo esc_attr($event['capacity']); ?>" placeholder="<?php esc_attr_e('e.g., Limited, 50 spots', 'simple-events'); ?>" />
                </div>
            </div>
        </div>
        <?php
        ...
        <div class="se-event-pricing">
            <p>
                <label>
                    ...
                    <?php esc_html_e('This is a free event', 'simple-events'); ?>
                </label>
            </p>
            <p>
                <label for="se_event_price"><?php esc_html_e('General admission', 'simple-events'); ?></label>
                <input type="text" id="se_event_price" name="se_event_price" value="<?php echo esc_attr($event['price']); ?>" placeholder="25" />
            </p>
            <p>
                <label for="se_event_price_child"><?php esc_html_e('Child price', 'simple-events'); ?></label>
            ...
            <p>
                <label for="se_event_price_adult"><?php esc_html_e('Adult price', 'simple-events'); ?></label>
